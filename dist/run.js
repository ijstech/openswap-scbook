(() => {
  ...
  import_components.Styles.cssRule("i-module--1", {
    width: "100%!important"
  });
  import_components.Styles.cssRule("i-panel.docs-module", {
    display: "block",
  ...
  // src/run.tsx
  var DocsRun = class extends import_components2.Module {
    ...
    async executeCode(script) {
      try {
        await import_components2.application.loadModule("", {
          script
        });
  ...
  DocsRun = __decorateClass([
    import_components2.customModule,
    (0, import_components2.customElements)("i-run")
  ], DocsRun);
})();
